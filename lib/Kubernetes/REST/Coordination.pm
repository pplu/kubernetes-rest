...
This module keeps the deprecated v0 API usable. Kubernetes::REST 0.01/0.02 (by JLMARTIN) used method names like C<< $api->Coordination->ListNamespacedLease(...) >>; calls like that still reach the cluster from here, translated onto the v1 API.

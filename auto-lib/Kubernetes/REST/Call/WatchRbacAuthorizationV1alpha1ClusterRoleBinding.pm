package Kubernetes::REST::Call::WatchRbacAuthorizationV1alpha1ClusterRoleBinding;
  use Moo;
  ...
  sub _url { '/apis/rbac.authorization.k8s.io/v1alpha1/watch/clusterrolebindings/{name}' }
  sub _method { 'GET' }
1;

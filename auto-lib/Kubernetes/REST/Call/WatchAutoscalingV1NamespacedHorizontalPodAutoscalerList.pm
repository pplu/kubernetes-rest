package Kubernetes::REST::Call::WatchAutoscalingV1NamespacedHorizontalPodAutoscalerList;
  use Moo;
  ...
  sub _url { '/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers' }
  sub _method { 'GET' }
1;

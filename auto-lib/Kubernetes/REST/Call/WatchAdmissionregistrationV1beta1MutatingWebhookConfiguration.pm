package Kubernetes::REST::Call::WatchAdmissionregistrationV1beta1MutatingWebhookConfiguration;
  use Moo;
  ...
  sub _url { '/apis/admissionregistration.k8s.io/v1beta1/watch/mutatingwebhookconfigurations/{name}' }
  sub _method { 'GET' }
1;

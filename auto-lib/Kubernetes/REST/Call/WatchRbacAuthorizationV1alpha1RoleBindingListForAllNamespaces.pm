package Kubernetes::REST::Call::WatchRbacAuthorizationV1alpha1RoleBindingListForAllNamespaces;
  use Moo;
  ...
  sub _url { '/apis/rbac.authorization.k8s.io/v1alpha1/watch/rolebindings' }
  sub _method { 'GET' }
1;

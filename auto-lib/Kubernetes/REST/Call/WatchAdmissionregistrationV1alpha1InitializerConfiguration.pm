package Kubernetes::REST::Call::WatchAdmissionregistrationV1alpha1InitializerConfiguration;
  use Moo;
  ...
  sub _url { '/apis/admissionregistration.k8s.io/v1alpha1/watch/initializerconfigurations/{name}' }
  sub _method { 'GET' }
1;

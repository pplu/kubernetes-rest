package Kubernetes::REST::Call::WatchSettingsV1alpha1NamespacedPodPreset;
  use Moo;
  ...
  sub _url { '/apis/settings.k8s.io/v1alpha1/watch/namespaces/{namespace}/podpresets/{name}' }
  sub _method { 'GET' }
1;

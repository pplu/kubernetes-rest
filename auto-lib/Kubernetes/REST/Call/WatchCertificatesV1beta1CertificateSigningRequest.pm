package Kubernetes::REST::Call::WatchCertificatesV1beta1CertificateSigningRequest;
  use Moo;
  ...
  sub _url { '/apis/certificates.k8s.io/v1beta1/watch/certificatesigningrequests/{name}' }
  sub _method { 'GET' }
1;

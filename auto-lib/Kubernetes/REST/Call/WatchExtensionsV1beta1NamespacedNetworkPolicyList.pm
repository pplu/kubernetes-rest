package Kubernetes::REST::Call::WatchExtensionsV1beta1NamespacedNetworkPolicyList;
  use Moo;
  ...
  sub _url { '/apis/extensions/v1beta1/watch/namespaces/{namespace}/networkpolicies' }
  sub _method { 'GET' }
1;
